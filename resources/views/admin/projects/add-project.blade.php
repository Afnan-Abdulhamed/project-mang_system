...
@section('content')
    ...
    <form accept-charset="utf-8" enctype="multipart/form-data" method="POST" action="/projects-manager/admin/projects">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="title" placeholder="Enter Project Title" name="name">
        </div>
        
        <div class="form-group">
            <label for="start-date">Start Date</label>
            <input type="datetime-local" class="form-control" id="start-date" describedby="emailHelp" placeholder="ex 2019-08-12 10:0:0" name="start_date">
            <small id="emailHelp" class="form-text text-muted" value="A">this field should be a datetime picker</small>
        </div>

        <div class="form-group">
            <label for="end-date">End Date</label>
            <input type="datetime-local" class="form-control" id="end-date" describedby="emailHelp" placeholder="ex 2019-08-12 10:0:0" name="end_date" >
            <small id="emailHelp" class="form-text text-muted" value="B">this field should be a datetime picker</small>
        </div>
